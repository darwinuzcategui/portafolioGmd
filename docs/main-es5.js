...
var AboutComponent = /** @class */ (function () {
    ...
    function AboutComponent(_infoServicio) {
...
var BuscarComponent = /** @class */ (function () {
    function BuscarComponent(ruta, productosService) {
        this.ruta = ruta;
        this.productosService = productosService;
    }
    BuscarComponent.prototype.ngOnInit = function () {
        ...
        this.ruta.params
            ...
            _this.productosService.buscarProducto(params['termino']);
        });
    };
...
var ItemComponent = /** @class */ (function () {
    ...
    ItemComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.productoService.getProducto(parametros['idProducto'])
                .subscribe(function (producto) {
                _this.id = parametros['idProducto'];
...
var PortafolioComponent = /** @class */ (function () {
    ...
    PortafolioComponent.ctorParameters = function () { return [
...
var InfoPaginaService = /** @class */ (function () {
    ...
    InfoPaginaService.ctorParameters = function () { return [
...
var ProductosService = /** @class */ (function () {
    ...
    ProductosService.prototype.cargarProductos = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get('https://darwinapp-106f8.firebaseio.com/productos_idx.json')
                .subscribe(function (resp) {
    ...
    ProductosService.prototype.filtrarProductos = function (termino) {
        ...
        this.productos.forEach(function (prod) {
            ...
            if (prod.categoria.indexOf(termino) >= 0 || tituloLower.indexOf(termino) >= 0) {
                _this.productoFiltrados.push(prod);
            }
        });
    };
...
var FooterComponent = /** @class */ (function () {
    // tslint:disable-next-line: variable-name
    function FooterComponent(_serviciof) {
